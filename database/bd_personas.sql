...
connect 'jdbc:derby://localhost:1527/studentsdb;create=true';
...
connect 'jdbc:derby://localhost:1527/studentsdb;user=dev;password=dev';

-- Create tables
CREATE TABLE STUDENTS (STUDENT_ID INT PRIMARY KEY, FIRST_NAME VARCHAR(20), LAST_NAME VARCHAR(20), EMAIL VARCHAR(30));
insert into STUDENTS values 
	(1,'Denisse','Velazquez','dvm@outlook.com'),
	(2,'Felix','Villagomez','fvr@outlook.com');